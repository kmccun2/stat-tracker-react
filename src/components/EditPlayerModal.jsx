...
const EditPlayerModal = ({ show, onHide, onPlayerUpdated, player, apiService }) => {
  ...
  useEffect(() => {
    if (player) {
      setFormData({
        ...
        dob: convertExcelSerialToDate(player.DOB || player.dob || '')
      });
    }
  }, [player]);
  ...
  const convertDateToExcelSerial = (dateString) => {
        ...
        <Modal.Body>
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Text className="text-muted">
              This will be used to calculate age and determine appropriate goals.
            </Form.Text>
          </Form.Group>
        </Modal.Body>
