...
const PlayerActionsDropdown = ({ player, onEdit, onDelete, apiService }) => {
    ...
    <>
      ...
      >
        ...
        <Dropdown.Menu align="end">
          <Dropdown.Item onClick={handleEditClick} className="d-flex align-items-center gap-2">
            <span>✏️</span>
            Edit Player
          </Dropdown.Item>
          <Dropdown.Divider />
      ...
      <Modal show={showDeleteModal} onHide={handleCloseDeleteModal} centered>
        ...
        <Modal.Body>
          ...
          <p>
            Are you sure you want to delete <strong>{player.Name || player.name}</strong>?
          </p>
